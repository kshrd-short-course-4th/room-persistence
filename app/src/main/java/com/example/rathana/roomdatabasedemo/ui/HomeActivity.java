...
import com.example.rathana.roomdatabasedemo.ui.MainActivity;
...
public class HomeActivity extends AppCompatActivity implements ArticleAdapter.ArticleAdapterCallback{
    @BindView(R.id.rvArticle)
    RecyclerView recyclerView;
    ArticleAdapter articleAdapter;
    List<CategoryArticle> categoryArticles;
    @Override
    ...
    private void setupRecyclerView() {
        ...
        articleAdapter=new ArticleAdapter(categoryArticles,this);
